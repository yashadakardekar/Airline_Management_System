...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    JTextField tfpnr;
    JLabel tfname, tfnationality, lbsrc, lbdest, labelfname, labeldate, labelfcode;
    JButton fetchButton;
    ...
    public BoardingPass() {
        ...
        fetchButton.addActionListener((ActionListener)this);
        add(fetchButton);
        ...
        lbdest = new JLabel();
        lbdest.setBounds(540, 220, 150, 25);
        add(lbdest);
    ...
    public void actionPerformed(ActionEvent ae) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    lbsrc.setText(rs.getString("src"));
                    lbdest.setText(rs.getString("des")); 
